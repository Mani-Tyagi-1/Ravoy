...
const overview = () => {
  ...
  return (
    <div className="min-w-screen h-[5371px]">
      ...
      <div className="flex ">
        <div className="sidebar w-[340px] h-[1935px] rounded-[10px] bg-[#FFF9F3] border mt-10 ml-[44px] ">
        ...
        <div className=" flex flex-col ">
          <div className="w-[1083px] h-[432px] rounded-[10px] mt-10 mx-[25px] bg-[#FFF9F3] flex justify-center items-center ">
            <div className="p-10">
              <h1 className="w-[287px] h-[25px] font-[Montserrat] font-[400] text-[24px] text-[#424242] mb-10 ">
                {" "}
                ACCOUNT OVERVIEW
              </h1>
              <div className="w-[1003px] h-[174px] border-[1px] border-[#0F6FA64D] ">
                <div className="w-full h-[52px] bg-[#D9D9D94D] flex justify-between items-center p-5 ">
          ...
          <div className="w-[1083px] h-[553px] rounded-[10px] mt-10 mx-[25px] bg-[#FFF9F3] flex justify-center items-center   ">
            <div className="p-10">
              ...
              <div className="w-[1003px] h-[300px] border-[1px] border-[#0F6FA64D] ">
                <div className="w-full h-[52px] bg-[#D9D9D94D] flex justify-between items-center p-5 ">
                  <h2 className="w-[296px] h-[25px] font-[Montserrat] font-[500] text-[20px] text-[#424242] ">
                    Default Address
                  </h2>
